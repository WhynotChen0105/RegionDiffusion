...
from ldm.modules.attention import GatedSelfAttentionDense, GatedRegionSelfAttentionDense
...
def load_ckpt(config, model, autoencoder, text_encoder, diffusion):
    ...
    print("ckpt loaded from: ", config.official_ckpt_name)
...
def set_alpha_scale(model, alpha_scale):
    for module in model.modules():
        if type(module) == GatedSelfAttentionDense or type(module) == GatedRegionSelfAttentionDense:
